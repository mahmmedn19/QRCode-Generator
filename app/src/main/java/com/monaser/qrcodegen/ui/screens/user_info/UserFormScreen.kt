        ...
        Card(
            ...
            Column(
                ...
                QRCodeTextField(
                    ...
                    errorMessage = if (showError && !state.isAgeValid) "Age must be between 12 and 100" else "",
                ...
                Box {
                    QRCodeTextField(
                        ...
                        onValueChange = { },
                        text = state.gender,
                        errorMessage = if (showError && !state.isGenderValid) "Invalid gender value" else "",
                        oneLineOnly = true,
                        keyboardOptions = KeyboardOptions.Default.copy(
                            imeAction = ImeAction.Next
                        ),
                ...
                QRCodeTextField(
                    ...
                    errorMessage = if (showError && !state.isPhoneNumberValid) "Phone number must be 11 digits" else "",
                    keyboardOptions = KeyboardOptions.Default.copy(
